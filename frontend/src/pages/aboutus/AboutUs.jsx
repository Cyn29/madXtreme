    ...
    return (
        <>
            ...
            <h5 className="text-center mb-5">
                ...
                antes. Con un equipo apasionado como el nuestro, cada aventura
                se convierte en una historia que contar, una experiencia que
                cambiará tu vida. ¡Deja que MadXtreme sea tu puerta de entrada a
                un mundo de emociones y descubrimientos en la naturaleza!
            </h5>
        </>
    );
}
