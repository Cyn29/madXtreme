...
CREATE TABLE activities (
    ...
    date1_activity INT NOT NULL,
    stock1_activity INT(10),
	date2_activity INT NOT NULL,
...
Regreso.', 55, '4.7/5 15 opiniones', 'Calle Colón, El Molar. Quedada a las 9.00am', 25112023, 15, 20122023, 10),
...
- Comida en la montaña.
- Regreso.', 55, '4.7/5 15 opiniones', 'Calle Esparragal, Aranda del Duero. Quedada a las 8.00am', 29122023, 10, 20012023, 10),
...
Comida en la montaña.
Regreso', 45, '4.7/5 12 opiniones' , 'Plaza Mayor La Hiruela. Quedada a las 9.00am', 11122023, 14, 20012024, 12),
...
- Comida en la montaña.
- Regreso.', 50, '4.5/5 10 opiniones', 'Avenida de la constitución, Narnia. Quedada a las 9.00am', 02022024, 9, 20052024, 11),
...
Comida en la montaña.
Regreso.', 45, '4.7/5 10 opiniones', 'Calle Don Bosco, Navacerrada. Quedada a las 9.00am', 27122023, 17, 20012024, 14),
...
Regreso.', 55, '4.7/5 15 opiniones' , 'Plaza Levante, Hogwarts. Quedada a las 8.15am', 11012024, 18, 11012024, 20);
