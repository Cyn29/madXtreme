                ...
                element: (
                    <>
                        <h1 className="text-center mt-5 mb-5">
                            Conoce el alma de MadXtreme
                        </h1>
                        <p className="text-center mt-2 m-4">
                            Nuestra pasión es explorar y descubrir la emoción en
                            cada rincón de la Comunidad de Madrid. Déjanos
                            presentarte a los héroes que hacen que MadXtreme sea
                            más que una aventura: es una experiencia
                            inolvidable.
                        </p>
                        <AboutUs
                            image={andrea}
                        ...
                        />
                        <p className="text-center m-5 mb-5">
                            Únete a MadXtreme y descubre la Comunidad de Madrid
                            como nunca antes. Con un equipo apasionado como el
                            nuestro, cada aventura se convierte en una historia
                            que contar, una experiencia que cambiará tu vida.
                            ¡Deja que MadXtreme sea tu puerta de entrada a un
                            mundo de emociones y descubrimientos en la
                            naturaleza!
                        </p>
                    </>
                ),
