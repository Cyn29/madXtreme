...
function Contact() {
  ...
  return (
    <section className="contact-container" aria-label="Contact">
      ...
      <div className="form-map-container d-flex">
        <div className="">
          <iframe
            src="
        ...
        <Form id="form" onSubmit={handleSubmit(() => {})}>
          <Form.Group className="formGroup">
            ...
            {errors.fullName?.type === "minLength" && (
              <p>El nombre debe tener más de 3 caracteres</p>
            )}
          </Form.Group>
          <Form.Group className="formGroup">
          ...
          <Form.Group className="formGroup">
            ...
            {errors.comments?.type === "minLength" && (
              <p>El comentario debe tener más de 3 caracteres</p>
            )}
          </Form.Group>
