    ...
    return (
        <nav aria-label="Navbar" className="navbar-container">
            ...
            <div className="mobile-menu">
                <button onClick={toggleDropdown} className="mobile-menu-button" aria-label="menu">
                    ☰
                </button>
                {showDropdown && (
                    <ul className="mobile-dropdown">
                        <li><a href="/" aria-label="home">Inicio</a></li>
                        <li><Link to="/aboutus" aria-label="aboutus">Nosotros</Link></li>
                        <li><Link to="/contact" aria-label="contact">Contacto</Link></li>
        ...
        <div className="right-container"></div>
            <main className="links-container">
                <ul className="ul-container">
                    ...
                    <a href="/aboutus" className="navbar-li" aria-label="aboutus">Nosotros</a>
                    <a href="/contact" className="navbar-li" aria-label="contact">Contacto</a>
